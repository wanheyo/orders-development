...
public class CreateDishAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_dish_admin);
...
//            ((TextView) findViewById(R.id.textViewPrice)).setText("Available Order (" + String.format("RM %.2f", dishes.getPrice()) + "/each)");
        ...
        btnAddDish = findViewById(R.id.btnAddOrderAvailable);
        ...
        et_dishprice.setTransformationMethod(new NumericKeyBoardTransformationMethod());
        et_dishprice.addTextChangedListener(new MoneyTextWatcher(et_dishprice));
    ...
    public void call_getDishType_API() {
        LoadingDialog loadingDialog = new LoadingDialog(CreateDishAdminActivity.this);
        ...
        apiService.getDishType().enqueue(new Callback<ArrayList<Dish_Type>>() {
            ...
            public void onFailure(Call<ArrayList<Dish_Type>> call, Throwable t) {
                loadingDialog.dismissDialog();
                Log.d("OrderS_API-getDishType()", "Response: API Response.");
                Toast.makeText(CreateDishAdminActivity.this, "Receive dish type failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void getDishType() {
        ...
        ArrayAdapter<String> adapterItem = new ArrayAdapter<>(CreateDishAdminActivity.this, R.layout.list_item, item);
        ...
        ac_dishtype.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(CreateDishAdminActivity.this, "Item: " + dishType, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void addDish() {
        ...
        if(!dishName.isEmpty() && !"RM0.00".equals(dishPrice) && !"Select".equals(dishType)) {
            ...
            if(dishName.isEmpty()) {
                Toast.makeText(CreateDishAdminActivity.this, "Dish name cannot be blank.", Toast.LENGTH_SHORT).show();
            } else if(dishPrice.isEmpty() || dishPrice.equals("RM0.00")) {
                Toast.makeText(CreateDishAdminActivity.this, "Dish price cannot be blank.", Toast.LENGTH_SHORT).show();
            } else if(dishType.isEmpty() || dishType.equals("Select")) {
                Toast.makeText(CreateDishAdminActivity.this, "Dish type cannot be blank.", Toast.LENGTH_SHORT).show();
            }
        }
    }

    public void call_addDishes_API() {
        LoadingDialog loadingDialog = new LoadingDialog(CreateDishAdminActivity.this);
        loadingDialog.startDialog();
        ...
        Log.d("OrderS_API-addDishes()", "Response: API Response, Success. " + fileImage);
...
//        MultipartBody.Part filePart = MultipartBody.Part.createFormData("dish_image", fileImage.getName(), requestBody);
        ...
        ApiService apiService = retrofit.create(ApiService.class);
        apiService.addDishes(organIdBody, dishNameBody, dishPriceBody, dishTypeBody, filePart).enqueue(new Callback<API_Resp>() {
            @Override
            public void onResponse(Call<API_Resp> call, Response<API_Resp> response) {
                if(response.isSuccessful()) {
                    loadingDialog.dismissDialog();
                    Log.d("OrderS_API-addDishes()", "Response: API Response, Success. " + response.body().getResponse());
                    //Toast.makeText(CartActivity.this, "Response: " + response.body().getResponse(), Toast.LENGTH_SHORT).show();
//                    Toast.makeText(CreateDishAdminActivity.this, "Dish added.", Toast.LENGTH_SHORT).show();
//                    Intent intent = new Intent(CreateDishAdminActivity.this, MainActivityAdmin.class);
...
//                    startActivity(intent);
                    ...
                    loadingDialog.dismissDialog();
                    Log.d("OrderS_API-addDishes()", "Response: API Response, Unsuccessful.");
            ...
            public void onFailure(Call<API_Resp> call, Throwable t) {
                loadingDialog.dismissDialog();
                Log.d("OrderS_API-addDishes()", "Response: API failed. " + t.getMessage());
                Toast.makeText(CreateDishAdminActivity.this, "Response: Failed", Toast.LENGTH_SHORT).show();
            }
        });
...
//        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK && data != null) {
            ...
            String path = mediaHandler.getPath(CreateDishAdminActivity.this, selectedImage);
            fileImage = new File(path);
            Log.d("onActivityResult()", "Response: Image Path. " + path);
            //ivAddDish.setImageURI(selectedImage);
            Glide.with(CreateDishAdminActivity.this)
